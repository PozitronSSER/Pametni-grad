...
void posaljiSve() {
  ...
  String data = String("field4 = " + String(stanje1, DEC) + "&field5 = " + String(stanje2, DEC) + "&field6 = " + String(stanje3, DEC));
...
void posaljiPrvi() {
  ...
  String data = String("field4 = " + String(stanje1, DEC));
  client.stop();
  if (client.connect(server, 80)) {
    client.println("POST / update HTTP / 1.1");
    client.println("Host: api.thingspeak.com");
...
void posaljiDrugi() {
  ...
  String data = String("field5 = " + String(stanje2, DEC));
  client.stop();
  if (client.connect(server, 80)) {
    client.println("POST / update HTTP / 1.1");
    client.println("Host: api.thingspeak.com");
...
void posaljiTreci() {
  ...
  String data = String("field6 = " + String(stanje3, DEC));
  client.stop();
  if (client.connect(server, 80)) {
    client.println("POST / update HTTP / 1.1");
    client.println("Host: api.thingspeak.com");
